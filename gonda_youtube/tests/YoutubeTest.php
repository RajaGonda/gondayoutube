...
class YoutubeTest extends TestCase
{
    ...
    {
        $this->youtube = new GondaYoutube(getenv("YOUTUBE_API_KEY"));
    }
    ...
    {
        $this->youtube = new GondaYoutube(array());
    }
    ...
    {
        $this->youtube = new GondaYoutube(array('key' => 'nonsense'));
        $vID = 'rie-hPVJ7Sw';
